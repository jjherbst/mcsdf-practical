...
class malware_analysis_report(FPDF):
    def add_cover_page(self, file_name: str, analysis_date: str):
        ...
        self.ln(30)
        self.cell(0, 15, "Malware Analysis & ", new_x="LMARGIN", new_y="NEXT", align="C")
        self.cell(0, 15, "Detection Report", new_x="LMARGIN", new_y="NEXT", align="C")
        self.ln(10)
        self.set_font("Arial", "", 14)
        self.set_text_color(60, 60, 60)
        self.cell(0, 10, "Custom Static Analysis Workflow", new_x="LMARGIN", new_y="NEXT", align="C")
        self.ln(20)
        ...
        disclaimer_text = ("This Report Is Generated for Academic Research Purposes as Part of the Auckland University of Technology Master of Cyber Security and Digital Forensics Program")
    ...
    def create_report(self, report: Dict[str, Any]):
        ...
        self.add_simple_section_page("Static Analysis", "File Metadata, Hash, Entropy & PE Header Characteristics")
        self.add_page()
        ...
        self.add_simple_section_page("YARA Analysis", "Detection Rules Matched & Indicators of Compromise")
        self.add_page()
